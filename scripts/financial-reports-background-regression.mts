...
assert.match(source, /accountCode === '1102060001'/);
assert.match(source, /سندات الصرف المنتظرة لا يكون لها قيد يومية/);
assert.match(source, /journal\.type === 'PV' && journal\.referenceCode === voucher\.voucherNumber/);
