...
console.log('WORKFLOW_STATUS_OK nonOpeningDraftModes=0 pendingPosting=true legacyMigration=true journal=true payment=true receipt=true custody=true dailyPosting=true monthlyCloseGuard=true yearlyCloseGuard=true openingBalancesDraftPreserved=true');
