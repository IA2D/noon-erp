...
assert.match(view, /displayedSavedRows/);
assert.doesNotMatch(view, /empty:\$\{fiscalYear/);
assert.match(view, /const browseModalRows = displayedSavedRows/);
assert.doesNotMatch(view, /رصيد مجمّع للعرض/);
