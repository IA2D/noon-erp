...
assert.match(view, /isSavedBalancesOpen/);
assert.match(view, /id="opening-balances-saved-browser"/);
assert.match(view, /استعراض الأرصدة المدخلة/);
assert.match(view, /showAllAccountsInBrowse/);
assert.match(view, /عرض الكل/);
assert.match(view, /opening-balances-delete-confirm/);
assert.match(view, /الخطوة 1 من 2/);
assert.match(view, /الخطوة 2 من 2/);
